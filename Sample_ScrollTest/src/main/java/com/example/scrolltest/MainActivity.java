...
/*
 ...
 2. 平滑移动视图的内容: 利用Scroller的startScroller方法和View的scroll方法
 	1). Scroller是实现View平滑移动的帮助类, 它本身并不能实现对View的移动
...
public class MainActivity extends Activity {
	...
	public void scrollLeft(View v) {
		...
		//iv_main.scrollTo(iv_main.getScrollX()+20, iv_main.getScrollY());
	}
